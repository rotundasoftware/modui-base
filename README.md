...
ModuiBase is a foundational view class inspired by and based on Backbone.View. It enables highly complex web interfaces to be built while still honoring Backbone's minimalist approach by facilitating the modularization of views into small, encapsulated, reusable components.
...
* A means to declare and access [options](#options) (a.k.a public properties)
